...
DROP TABLE IF EXISTS requester_product;
...
(
    ...
    content        varchar(300)               not null comment '설명',
...
create table if not exists recycle_like
(
    id         bigint auto_increment
        primary key,
...
create table if not exists requester_product
(
    id         bigint auto_increment
        primary key,
    product_id bigint not null
